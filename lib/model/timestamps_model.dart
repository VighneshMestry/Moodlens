...
//   final List<MeetingData> timestampsData;

//   TimestampsResponse({required this.timestampsData});

//   factory TimestampsResponse.fromJson(Map<String, dynamic> json) => TimestampsResponse(
//         timestampsData: (json['timestamps_data'] as List)
//             .map((e) => MeetingData.fromJson(e))
//             .toList(),
//       );
// }
